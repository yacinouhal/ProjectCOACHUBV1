...
// Vérifier si la variable de session admin est définie
if (!isset($_SESSION['admin']) || !$_SESSION['admin']) {
    // Si non définie ou égale à faux, rediriger vers la page de connexion
...
$userInstance = new user(null, null, null, null, null, null, null, null, null, null, null, null, null);
...
if (isset($_GET['id'])) {
    ...
    // Rediriger vers la page Admin Dashboard.php après la suppression
  ...
  * License: https://bootstrapmade.com/license/
  ...
  <div class="d-flex align-items-center justify-content-between">
    <a href="dashbord.php" class="logo d-flex align-items-center">
      <img src="https://i.postimg.cc/8CCmX23W/icon.png" alt="Custom Logo" />
      <span class="d-none d-lg-block">COACHUB</span>
    </a>
      ...
      <div class="pagetitle">
        ...
        <nav>
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="users-profile.html">users</a></li>
