...
class ReservationCoachC
{
    ...
    public function addReservation($reservation)
    {
        ...
        try {
            ...
            $result = $db->query("SELECT MAX(id_reservation_coach) AS maxId FROM coach_sportif_reservation");
            ...
            $sql = "INSERT INTO coach_sportif_reservation (nom, prenom, email, tel, date_seance_sportive) 
